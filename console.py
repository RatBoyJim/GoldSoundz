...
album_1 = Album("Crooked Rain Crooked Rain", "Pavement", "Matador", 4, 2, 5.00, 10.00, "Alternative")
album_repository.save(album_1)

album_2 = Album("Doolittle", "Pixies", "4AD", 3, 3, 4.00, 10.00, "Alternative")
album_repository.save(album_2)

album_3 = Album("Surfer Rosa", "Pixies", "4AD", 6, 4, 3.00, 5.00, "Alternative")
